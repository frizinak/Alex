...
function notice(str, critical) {
    var labelTip = $('#labeltip');
    //labelTip.html(str).css({'background-color': (critical === 1 ? '#833' : '#388'), 'left': ($(window).width() / 2 - labelTip.width() / 2) + 'px'}).show().stop(true, true).fadeTo(0, 1).delay(3000).fadeOut(2000);
    labelTip.html(str).stop(true, true).fadeTo(200, 1).delay(5000).fadeTo(2000, 0);
